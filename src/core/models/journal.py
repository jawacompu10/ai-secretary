...
class Journal(BaseModel):
    ...
    description: str | None = Field(default=None, description="Journal content/description")
    calendar_name: str = Field(..., description="Name of the calendar containing this journal")
    date_utc: datetime | None = Field(default=None, description="Journal date in UTC (internal storage)")
    date_local: str | None = Field(default=None, description="Journal date in user's timezone (for display)")
