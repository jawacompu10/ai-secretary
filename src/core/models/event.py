...
class EventCreate(BaseModel):
    ...
    calendar_name: str = Field(..., description="Name of the calendar to add the event to")
    start_datetime: str = Field(..., description="Start datetime in ISO format with timezone (YYYY-MM-DDTHH:MM:SS+TZ or YYYY-MM-DDTHH:MM:SSZ)")
    end_datetime: str = Field(..., description="End datetime in ISO format with timezone (YYYY-MM-DDTHH:MM:SS+TZ or YYYY-MM-DDTHH:MM:SSZ)")
    description: str | None = Field(None, description="Optional detailed event description")
    location: str | None = Field(None, description="Optional event location")
    rrule: str | None = Field(None, description="Recurrence rule in RRULE format (e.g., 'FREQ=WEEKLY;BYDAY=TU')")
...
class EventUpdate(BaseModel):
    ...
    new_start_datetime: str | None = Field(None, description="New start datetime in ISO format with timezone (YYYY-MM-DDTHH:MM:SS+TZ or YYYY-MM-DDTHH:MM:SSZ)")
    new_end_datetime: str | None = Field(None, description="New end datetime in ISO format with timezone (YYYY-MM-DDTHH:MM:SS+TZ or YYYY-MM-DDTHH:MM:SSZ)")
    ...
    new_rrule: str | None = Field(None, description="New recurrence rule in RRULE format")
...
class EventInstanceCancel(BaseModel):
    ...
    summary: str = Field(..., description="Recurring event summary to identify the event series")
    calendar_name: str = Field(..., description="Calendar containing the event")
    instance_date: str = Field(..., description="Date of the specific instance to cancel in ISO format (YYYY-MM-DD)")
...
class EventInstanceModify(BaseModel):
    ...
    summary: str = Field(..., description="Recurring event summary to identify the event series")
    calendar_name: str = Field(..., description="Calendar containing the event")
    instance_date: str = Field(..., description="Date of the specific instance to modify in ISO format (YYYY-MM-DD)")
    new_start_datetime: str | None = Field(None, description="New start datetime for this instance in ISO format with timezone")
    new_end_datetime: str | None = Field(None, description="New end datetime for this instance in ISO format with timezone")
    new_description: str | None = Field(None, description="New description for this instance")
...
class Event(BaseModel):
    ...
    calendar_name: str = Field(..., description="Name of the calendar containing this event")
    start_datetime_utc: datetime | None = Field(default=None, description="Event start time in UTC (internal storage)")
    end_datetime_utc: datetime | None = Field(default=None, description="Event end time in UTC (internal storage)")
    start_datetime_local: str | None = Field(default=None, description="Event start time in user's timezone (for display)")
    end_datetime_local: str | None = Field(default=None, description="Event end time in user's timezone (for display)")
